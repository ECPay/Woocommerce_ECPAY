...
class Wooecpay_Gateway_Cvs extends Wooecpay_Gateway_Base
{
    ...
    public function process_admin_options()
    {
        ...
        if ($_POST['woocommerce_Wooecpay_Gateway_Cvs_expire_date'] < 1 || $_POST['woocommerce_Wooecpay_Gateway_Cvs_expire_date'] > 43200) {
            ...
            WC_Admin_Settings::add_error(__('CVS payment deadline out of range. Set as default value.', 'wooecpay'));
        }
        ...
        if ($_POST['woocommerce_Wooecpay_Gateway_Cvs_max_amount'] > 6000) {
            ...
            WC_Admin_Settings::add_message(sprintf(__('%1$s maximum amount more then normal maximum (%2$d).', 'wooecpay'), $this->method_title, 6000));
        }
    ...
    public function process_payment($order_id)
    {
        ...
        $order->add_order_note(__('Pay via ECPay CVS', 'wooecpay'));
