...
class Wooecpay_Gateway_Barcode extends Wooecpay_Gateway_Base
{
    ...
    public function process_admin_options()
    {
        ...
        if ($_POST['woocommerce_Wooecpay_Gateway_Barcode_max_amount'] > 20000) {
            ...
            WC_Admin_Settings::add_message(sprintf(__('%1$s maximum amount more then normal maximum (%2$d).', 'wooecpay'), $this->method_title, 20000));
        }
    ...
    public function process_payment($order_id)
    {
        ...
        $order->add_order_note(__('Pay via ECPay BARCODE', 'wooecpay'));
