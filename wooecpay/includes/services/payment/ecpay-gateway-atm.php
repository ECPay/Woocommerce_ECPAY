...
class Wooecpay_Gateway_Atm extends Wooecpay_Gateway_Base
{
    ...
    public function process_admin_options()
    {
        ...
        if ( $_POST['woocommerce_' . $this->id . '_expire_date'] < 1 || $_POST['woocommerce_' . $this->id . '_expire_date'] > 60) {
            ...
            WC_Admin_Settings::add_error(sprintf(__('%s ATM payment deadline out of range. Set as default value.', 'wooecpay'), $this->method_title));
        }
    ...
    public function process_payment($order_id)
    {
        ...
        $order->add_order_note(__('Pay via ECPay ATM', 'wooecpay'));
